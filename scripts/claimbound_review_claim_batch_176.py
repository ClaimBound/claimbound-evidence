#!/usr/bin/env python3
"""Publish conservatively reviewed issue #176 source-boundary cards."""
...
REPORT = ROOT / "artifacts/claim_batch_176_manual_review.json"
EXECUTION = ROOT / "artifacts/claim_batch_176_execution_manifest.json"
PROTOCOL = "CB7K-ISSUE-176-CONSERVATIVE-LOCATOR-REVIEW-2026-07-23-v1"

SOURCE_NAMES = {
    "DOM031-T01": "Official public source topic 031-01",
    "DOM031-T02": "Official public source topic 031-02",
    "DOM031-T03": "Official public source topic 031-03",
    "DOM031-T04": "Official public source topic 031-04",
    "DOM031-T05": "Official public source topic 031-05",
    "DOM031-T06": "Official public source topic 031-06",
    "DOM031-T07": "Official public source topic 031-07",
    "DOM032-T01": "Official public source topic 032-01",
    "DOM032-T02": "Official public source topic 032-02",
    "DOM032-T03": "Official public source topic 032-03",
    "DOM032-T04": "Official public source topic 032-04",
    "DOM032-T05": "Official public source topic 032-05",
    "DOM032-T06": "Official public source topic 032-06",
    "DOM032-T07": "Official public source topic 032-07",
    "DOM033-T01": "Official public source topic 033-01",
    "DOM033-T02": "Official public source topic 033-02",
    "DOM033-T03": "Official public source topic 033-03",
    "DOM033-T04": "Official public source topic 033-04",
    "DOM033-T05": "Official public source topic 033-05",
    "DOM033-T06": "Official public source topic 033-06",
    "DOM033-T07": "Official public source topic 033-07",
}
...
def main() -> None:
    ...
    if len(sources) != 21 or any(len({x["source_url"] for x in manifest["sources"] if x["key"].startswith(d)}) < 7 for d in ("DOM031", "DOM032", "DOM033")):
    ...
    validate(ds, catalog)
    claims = [c for c in catalog if c["domain_code"] in {"DOM031", "DOM032", "DOM033"}]
        ...
        json.dumps(
            {
                ...
                "claim_boundary": "Claim-level execution plan for issue #176 only; it is not evidence and predeclares no outcome.",
        ...
        json.dumps(
            {
                ...
                "source_manifest_sha256": manifest_sha,
                "claim_boundary": "Conservative manual review of 21 preregistered clinical-trial, medical-device and diagnostic topic URLs for issue #176; no source replacement after observation.",
    ...
    for row in rows:
        ...
        card = {
            ...
            "runner_command": "python scripts/claimbound_review_claim_batch_176.py --manifest <local> --raw-root <local> --meta-root <local> --text-root <local> --operator <handle>",
