#!/usr/bin/env python3
"""Publish conservatively reviewed issue #184 source-boundary cards."""
...
REPORT = ROOT / "artifacts/claim_batch_184_manual_review.json"
EXECUTION = ROOT / "artifacts/claim_batch_184_execution_manifest.json"
PROTOCOL = "CB7K-ISSUE-184-CONSERVATIVE-LOCATOR-REVIEW-2026-07-23-v1"

SOURCE_NAMES = {
    "DOM055-T01": "Official public source topic 055-01",
    "DOM055-T02": "Official public source topic 055-02",
    "DOM055-T03": "Official public source topic 055-03",
    "DOM055-T04": "Official public source topic 055-04",
    "DOM055-T05": "Official public source topic 055-05",
    "DOM055-T06": "Official public source topic 055-06",
    "DOM055-T07": "Official public source topic 055-07",
    "DOM056-T01": "Official public source topic 056-01",
    "DOM056-T02": "Official public source topic 056-02",
    "DOM056-T03": "Official public source topic 056-03",
    "DOM056-T04": "Official public source topic 056-04",
    "DOM056-T05": "Official public source topic 056-05",
    "DOM056-T06": "Official public source topic 056-06",
    "DOM056-T07": "Official public source topic 056-07",
    "DOM057-T01": "Official public source topic 057-01",
    "DOM057-T02": "Official public source topic 057-02",
    "DOM057-T03": "Official public source topic 057-03",
    "DOM057-T04": "Official public source topic 057-04",
    "DOM057-T05": "Official public source topic 057-05",
    "DOM057-T06": "Official public source topic 057-06",
    "DOM057-T07": "Official public source topic 057-07",
}
...
def main() -> None:
    ...
    if len(sources) != 21 or any(len({x["source_url"] for x in manifest["sources"] if x["key"].startswith(d)}) < 7 for d in ("DOM055", "DOM056", "DOM057")):
    ...
    validate(ds, catalog)
    claims = [c for c in catalog if c["domain_code"] in {"DOM055", "DOM056", "DOM057"}]
        ...
        json.dumps(
            {
                ...
                "claim_boundary": "Claim-level execution plan for issue #184 only; it is not evidence and predeclares no outcome.",
        ...
        json.dumps(
            {
                ...
                "source_manifest_sha256": manifest_sha,
                "claim_boundary": "Conservative manual review of 21 preregistered clinical-trial, medical-device and diagnostic topic URLs for issue #184; no source replacement after observation.",
    ...
    for row in rows:
        ...
        card = {
            ...
            "runner_command": "python scripts/claimbound_review_claim_batch_184.py --manifest <local> --raw-root <local> --meta-root <local> --text-root <local> --operator <handle>",
