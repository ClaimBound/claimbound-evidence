#!/usr/bin/env python3
"""Publish conservatively reviewed issue #177 source-boundary cards."""
...
REPORT = ROOT / "artifacts/claim_batch_177_manual_review.json"
EXECUTION = ROOT / "artifacts/claim_batch_177_execution_manifest.json"
PROTOCOL = "CB7K-ISSUE-177-CONSERVATIVE-LOCATOR-REVIEW-2026-07-23-v1"

SOURCE_NAMES = {
    "DOM034-T01": "Official public source topic 034-01",
    "DOM034-T02": "Official public source topic 034-02",
    "DOM034-T03": "Official public source topic 034-03",
    "DOM034-T04": "Official public source topic 034-04",
    "DOM034-T05": "Official public source topic 034-05",
    "DOM034-T06": "Official public source topic 034-06",
    "DOM034-T07": "Official public source topic 034-07",
    "DOM035-T01": "Official public source topic 035-01",
    "DOM035-T02": "Official public source topic 035-02",
    "DOM035-T03": "Official public source topic 035-03",
    "DOM035-T04": "Official public source topic 035-04",
    "DOM035-T05": "Official public source topic 035-05",
    "DOM035-T06": "Official public source topic 035-06",
    "DOM035-T07": "Official public source topic 035-07",
    "DOM036-T01": "Official public source topic 036-01",
    "DOM036-T02": "Official public source topic 036-02",
    "DOM036-T03": "Official public source topic 036-03",
    "DOM036-T04": "Official public source topic 036-04",
    "DOM036-T05": "Official public source topic 036-05",
    "DOM036-T06": "Official public source topic 036-06",
    "DOM036-T07": "Official public source topic 036-07",
}
...
def main() -> None:
    ...
    if len(sources) != 21 or any(len({x["source_url"] for x in manifest["sources"] if x["key"].startswith(d)}) < 7 for d in ("DOM034", "DOM035", "DOM036")):
    ...
    validate(ds, catalog)
    claims = [c for c in catalog if c["domain_code"] in {"DOM034", "DOM035", "DOM036"}]
        ...
        json.dumps(
            {
                ...
                "claim_boundary": "Claim-level execution plan for issue #177 only; it is not evidence and predeclares no outcome.",
        ...
        json.dumps(
            {
                ...
                "source_manifest_sha256": manifest_sha,
                "claim_boundary": "Conservative manual review of 21 preregistered clinical-trial, medical-device and diagnostic topic URLs for issue #177; no source replacement after observation.",
    ...
    for row in rows:
        ...
        card = {
            ...
            "runner_command": "python scripts/claimbound_review_claim_batch_177.py --manifest <local> --raw-root <local> --meta-root <local> --text-root <local> --operator <handle>",
