#!/usr/bin/env python3
"""Publish conservatively reviewed issue #178 source-boundary cards."""
...
REPORT = ROOT / "artifacts/claim_batch_178_manual_review.json"
EXECUTION = ROOT / "artifacts/claim_batch_178_execution_manifest.json"
PROTOCOL = "CB7K-ISSUE-178-CONSERVATIVE-LOCATOR-REVIEW-2026-07-23-v1"

SOURCE_NAMES = {
    "DOM037-T01": "Official public source topic 037-01",
    "DOM037-T02": "Official public source topic 037-02",
    "DOM037-T03": "Official public source topic 037-03",
    "DOM037-T04": "Official public source topic 037-04",
    "DOM037-T05": "Official public source topic 037-05",
    "DOM037-T06": "Official public source topic 037-06",
    "DOM037-T07": "Official public source topic 037-07",
    "DOM038-T01": "Official public source topic 038-01",
    "DOM038-T02": "Official public source topic 038-02",
    "DOM038-T03": "Official public source topic 038-03",
    "DOM038-T04": "Official public source topic 038-04",
    "DOM038-T05": "Official public source topic 038-05",
    "DOM038-T06": "Official public source topic 038-06",
    "DOM038-T07": "Official public source topic 038-07",
    "DOM039-T01": "Official public source topic 039-01",
    "DOM039-T02": "Official public source topic 039-02",
    "DOM039-T03": "Official public source topic 039-03",
    "DOM039-T04": "Official public source topic 039-04",
    "DOM039-T05": "Official public source topic 039-05",
    "DOM039-T06": "Official public source topic 039-06",
    "DOM039-T07": "Official public source topic 039-07",
}
...
def main() -> None:
    ...
    if len(sources) != 21 or any(len({x["source_url"] for x in manifest["sources"] if x["key"].startswith(d)}) < 7 for d in ("DOM037", "DOM038", "DOM039")):
    ...
    validate(ds, catalog)
    claims = [c for c in catalog if c["domain_code"] in {"DOM037", "DOM038", "DOM039"}]
        ...
        json.dumps(
            {
                ...
                "claim_boundary": "Claim-level execution plan for issue #178 only; it is not evidence and predeclares no outcome.",
        ...
        json.dumps(
            {
                ...
                "source_manifest_sha256": manifest_sha,
                "claim_boundary": "Conservative manual review of 21 preregistered clinical-trial, medical-device and diagnostic topic URLs for issue #178; no source replacement after observation.",
    ...
    for row in rows:
        ...
        card = {
            ...
            "runner_command": "python scripts/claimbound_review_claim_batch_178.py --manifest <local> --raw-root <local> --meta-root <local> --text-root <local> --operator <handle>",
