#!/usr/bin/env python3
"""Publish conservatively reviewed issue #183 source-boundary cards."""
...
REPORT = ROOT / "artifacts/claim_batch_183_manual_review.json"
EXECUTION = ROOT / "artifacts/claim_batch_183_execution_manifest.json"
PROTOCOL = "CB7K-ISSUE-183-CONSERVATIVE-LOCATOR-REVIEW-2026-07-23-v1"

SOURCE_NAMES = {
    "DOM052-T01": "Official public source topic 052-01",
    "DOM052-T02": "Official public source topic 052-02",
    "DOM052-T03": "Official public source topic 052-03",
    "DOM052-T04": "Official public source topic 052-04",
    "DOM052-T05": "Official public source topic 052-05",
    "DOM052-T06": "Official public source topic 052-06",
    "DOM052-T07": "Official public source topic 052-07",
    "DOM053-T01": "Official public source topic 053-01",
    "DOM053-T02": "Official public source topic 053-02",
    "DOM053-T03": "Official public source topic 053-03",
    "DOM053-T04": "Official public source topic 053-04",
    "DOM053-T05": "Official public source topic 053-05",
    "DOM053-T06": "Official public source topic 053-06",
    "DOM053-T07": "Official public source topic 053-07",
    "DOM054-T01": "Official public source topic 054-01",
    "DOM054-T02": "Official public source topic 054-02",
    "DOM054-T03": "Official public source topic 054-03",
    "DOM054-T04": "Official public source topic 054-04",
    "DOM054-T05": "Official public source topic 054-05",
    "DOM054-T06": "Official public source topic 054-06",
    "DOM054-T07": "Official public source topic 054-07",
}
...
def main() -> None:
    ...
    if len(sources) != 21 or any(len({x["source_url"] for x in manifest["sources"] if x["key"].startswith(d)}) < 7 for d in ("DOM052", "DOM053", "DOM054")):
    ...
    validate(ds, catalog)
    claims = [c for c in catalog if c["domain_code"] in {"DOM052", "DOM053", "DOM054"}]
        ...
        json.dumps(
            {
                ...
                "claim_boundary": "Claim-level execution plan for issue #183 only; it is not evidence and predeclares no outcome.",
        ...
        json.dumps(
            {
                ...
                "source_manifest_sha256": manifest_sha,
                "claim_boundary": "Conservative manual review of 21 preregistered clinical-trial, medical-device and diagnostic topic URLs for issue #183; no source replacement after observation.",
    ...
    for row in rows:
        ...
        card = {
            ...
            "runner_command": "python scripts/claimbound_review_claim_batch_183.py --manifest <local> --raw-root <local> --meta-root <local> --text-root <local> --operator <handle>",
