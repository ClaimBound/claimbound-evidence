#!/usr/bin/env python3
"""Publish conservatively reviewed issue #172 source-boundary cards."""
...
REPORT = ROOT / "artifacts/claim_batch_172_manual_review.json"
EXECUTION = ROOT / "artifacts/claim_batch_172_execution_manifest.json"
PROTOCOL = "CB7K-ISSUE-172-CONSERVATIVE-LOCATOR-REVIEW-2026-07-23-v1"

SOURCE_NAMES = {
    "DOM019-T01": "Official public source topic 019-01",
    "DOM019-T02": "Official public source topic 019-02",
    "DOM019-T03": "Official public source topic 019-03",
    "DOM019-T04": "Official public source topic 019-04",
    "DOM019-T05": "Official public source topic 019-05",
    "DOM019-T06": "Official public source topic 019-06",
    "DOM019-T07": "Official public source topic 019-07",
    "DOM020-T01": "Official public source topic 020-01",
    "DOM020-T02": "Official public source topic 020-02",
    "DOM020-T03": "Official public source topic 020-03",
    "DOM020-T04": "Official public source topic 020-04",
    "DOM020-T05": "Official public source topic 020-05",
    "DOM020-T06": "Official public source topic 020-06",
    "DOM020-T07": "Official public source topic 020-07",
    "DOM021-T01": "Official public source topic 021-01",
    "DOM021-T02": "Official public source topic 021-02",
    "DOM021-T03": "Official public source topic 021-03",
    "DOM021-T04": "Official public source topic 021-04",
    "DOM021-T05": "Official public source topic 021-05",
    "DOM021-T06": "Official public source topic 021-06",
    "DOM021-T07": "Official public source topic 021-07",
}
...
def main() -> None:
    ...
    if len(sources) != 21 or any(len({x["source_url"] for x in manifest["sources"] if x["key"].startswith(d)}) < 7 for d in ("DOM019", "DOM020", "DOM021")):
    ...
    validate(ds, catalog)
    claims = [c for c in catalog if c["domain_code"] in {"DOM019", "DOM020", "DOM021"}]
        ...
        json.dumps(
            {
                ...
                "claim_boundary": "Claim-level execution plan for issue #172 only; it is not evidence and predeclares no outcome.",
        ...
        json.dumps(
            {
                ...
                "source_manifest_sha256": manifest_sha,
                "claim_boundary": "Conservative manual review of 21 preregistered clinical-trial, medical-device and diagnostic topic URLs for issue #172; no source replacement after observation.",
    ...
    for row in rows:
        ...
        card = {
            ...
            "runner_command": "python scripts/claimbound_review_claim_batch_172.py --manifest <local> --raw-root <local> --meta-root <local> --text-root <local> --operator <handle>",
