#!/usr/bin/env python3
"""Publish conservatively reviewed issue #173 source-boundary cards."""
...
REPORT = ROOT / "artifacts/claim_batch_173_manual_review.json"
EXECUTION = ROOT / "artifacts/claim_batch_173_execution_manifest.json"
PROTOCOL = "CB7K-ISSUE-173-CONSERVATIVE-LOCATOR-REVIEW-2026-07-23-v1"

SOURCE_NAMES = {
    "DOM022-T01": "Official public source topic 022-01",
    "DOM022-T02": "Official public source topic 022-02",
    "DOM022-T03": "Official public source topic 022-03",
    "DOM022-T04": "Official public source topic 022-04",
    "DOM022-T05": "Official public source topic 022-05",
    "DOM022-T06": "Official public source topic 022-06",
    "DOM022-T07": "Official public source topic 022-07",
    "DOM023-T01": "Official public source topic 023-01",
    "DOM023-T02": "Official public source topic 023-02",
    "DOM023-T03": "Official public source topic 023-03",
    "DOM023-T04": "Official public source topic 023-04",
    "DOM023-T05": "Official public source topic 023-05",
    "DOM023-T06": "Official public source topic 023-06",
    "DOM023-T07": "Official public source topic 023-07",
    "DOM024-T01": "Official public source topic 024-01",
    "DOM024-T02": "Official public source topic 024-02",
    "DOM024-T03": "Official public source topic 024-03",
    "DOM024-T04": "Official public source topic 024-04",
    "DOM024-T05": "Official public source topic 024-05",
    "DOM024-T06": "Official public source topic 024-06",
    "DOM024-T07": "Official public source topic 024-07",
}
...
def main() -> None:
    ...
    if len(sources) != 21 or any(len({x["source_url"] for x in manifest["sources"] if x["key"].startswith(d)}) < 7 for d in ("DOM022", "DOM023", "DOM024")):
    ...
    validate(ds, catalog)
    claims = [c for c in catalog if c["domain_code"] in {"DOM022", "DOM023", "DOM024"}]
        ...
        json.dumps(
            {
                ...
                "claim_boundary": "Claim-level execution plan for issue #173 only; it is not evidence and predeclares no outcome.",
        ...
        json.dumps(
            {
                ...
                "source_manifest_sha256": manifest_sha,
                "claim_boundary": "Conservative manual review of 21 preregistered clinical-trial, medical-device and diagnostic topic URLs for issue #173; no source replacement after observation.",
    ...
    for row in rows:
        ...
        card = {
            ...
            "runner_command": "python scripts/claimbound_review_claim_batch_173.py --manifest <local> --raw-root <local> --meta-root <local> --text-root <local> --operator <handle>",
