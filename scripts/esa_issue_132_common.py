...
"""Shared helpers for the ESA issue #132 local batch runner."""
...
MATRIX_EXPORT_PATH = REPO_ROOT / "docs" / "esa" / "issue_132_claim_matrix.json"
REGISTRY_PATH = REPO_ROOT / "docs" / "registry" / "evidence_index.json"
CARDS_DIR = REPO_ROOT / "docs" / "evidence_cards"
SUMMARY_PATH = REPO_ROOT / "artifacts" / "esa_issue_132_batch_summary.json"
RUNBOOK_RESULT_PATH = (
    REPO_ROOT / "docs" / "manual_audit" / "ESA-ISSUE-132" / "README.md"
)
USER_AGENT = (
...
def registry_statistics(cards: list[dict[str, Any]]) -> dict[str, dict[str, int]]:
