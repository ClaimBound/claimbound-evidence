#!/usr/bin/env python3
"""Publish conservatively reviewed issue #175 source-boundary cards."""
...
SOURCE_NAMES = {
    ...
    "DOM028-T02": "Official public source topic 028-02",
    "DOM028-T03": "Official public source topic 028-03",
    "DOM028-T04": "Official public source topic 028-04",
    "DOM028-T05": "Official public source topic 028-05",
    "DOM028-T06": "Official public source topic 028-06",
    "DOM028-T07": "Official public source topic 028-07",
    "DOM029-T01": "Official public source topic 029-01",
    "DOM029-T02": "Official public source topic 029-02",
    "DOM029-T03": "Official public source topic 029-03",
    "DOM029-T04": "Official public source topic 029-04",
    "DOM029-T05": "Official public source topic 029-05",
    "DOM029-T06": "Official public source topic 029-06",
    "DOM029-T07": "Official public source topic 029-07",
    "DOM030-T01": "Official public source topic 030-01",
    "DOM030-T02": "Official public source topic 030-02",
    "DOM030-T03": "Official public source topic 030-03",
    "DOM030-T04": "Official public source topic 030-04",
    "DOM030-T05": "Official public source topic 030-05",
...
def main() -> None:
    ...
    if len(sources) != 21 or any(len({x["source_url"] for x in manifest["sources"] if x["key"].startswith(d)}) < 7 for d in ("DOM028", "DOM029", "DOM030")):
    ...
    validate(ds, catalog)
    claims = [c for c in catalog if c["domain_code"] in {"DOM028", "DOM029", "DOM030"}]
        ...
        json.dumps(
            {
                ...
                "claim_boundary": "Claim-level execution plan for issue #175 only; it is not evidence and predeclares no outcome.",
    ...
    for row in rows:
        ...
        card = {
            ...
            "runner_command": "python scripts/claimbound_review_claim_batch_175.py --manifest <local> --raw-root <local> --meta-root <local> --text-root <local> --operator <handle>",
