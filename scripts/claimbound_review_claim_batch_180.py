#!/usr/bin/env python3
"""Publish conservatively reviewed issue #180 source-boundary cards."""
...
REPORT = ROOT / "artifacts/claim_batch_180_manual_review.json"
EXECUTION = ROOT / "artifacts/claim_batch_180_execution_manifest.json"
PROTOCOL = "CB7K-ISSUE-180-CONSERVATIVE-LOCATOR-REVIEW-2026-07-23-v1"

SOURCE_NAMES = {
    "DOM043-T01": "Official public source topic 043-01",
    "DOM043-T02": "Official public source topic 043-02",
    "DOM043-T03": "Official public source topic 043-03",
    "DOM043-T04": "Official public source topic 043-04",
    "DOM043-T05": "Official public source topic 043-05",
    "DOM043-T06": "Official public source topic 043-06",
    "DOM043-T07": "Official public source topic 043-07",
    "DOM044-T01": "Official public source topic 044-01",
    "DOM044-T02": "Official public source topic 044-02",
    "DOM044-T03": "Official public source topic 044-03",
    "DOM044-T04": "Official public source topic 044-04",
    "DOM044-T05": "Official public source topic 044-05",
    "DOM044-T06": "Official public source topic 044-06",
    "DOM044-T07": "Official public source topic 044-07",
    "DOM045-T01": "Official public source topic 045-01",
    "DOM045-T02": "Official public source topic 045-02",
    "DOM045-T03": "Official public source topic 045-03",
    "DOM045-T04": "Official public source topic 045-04",
    "DOM045-T05": "Official public source topic 045-05",
    "DOM045-T06": "Official public source topic 045-06",
    "DOM045-T07": "Official public source topic 045-07",
}
...
def main() -> None:
    ...
    if len(sources) != 21 or any(len({x["source_url"] for x in manifest["sources"] if x["key"].startswith(d)}) < 7 for d in ("DOM043", "DOM044", "DOM045")):
    ...
    validate(ds, catalog)
    claims = [c for c in catalog if c["domain_code"] in {"DOM043", "DOM044", "DOM045"}]
        ...
        json.dumps(
            {
                ...
                "claim_boundary": "Claim-level execution plan for issue #180 only; it is not evidence and predeclares no outcome.",
        ...
        json.dumps(
            {
                ...
                "source_manifest_sha256": manifest_sha,
                "claim_boundary": "Conservative manual review of 21 preregistered clinical-trial, medical-device and diagnostic topic URLs for issue #180; no source replacement after observation.",
    ...
    for row in rows:
        ...
        card = {
            ...
            "runner_command": "python scripts/claimbound_review_claim_batch_180.py --manifest <local> --raw-root <local> --meta-root <local> --text-root <local> --operator <handle>",
