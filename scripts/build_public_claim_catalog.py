...
('conflicts-disclosure','Funding, vendor, sponsor, author, ownership, procurement, or institutional interests relevant to {topic} are disclosed inside the audit boundary.','Disclosure is not proof of bias; missing disclosure is not proof of misconduct.'),
