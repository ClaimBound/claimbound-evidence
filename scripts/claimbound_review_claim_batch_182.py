#!/usr/bin/env python3
"""Publish conservatively reviewed issue #182 source-boundary cards."""
...
REPORT = ROOT / "artifacts/claim_batch_182_manual_review.json"
EXECUTION = ROOT / "artifacts/claim_batch_182_execution_manifest.json"
PROTOCOL = "CB7K-ISSUE-182-CONSERVATIVE-LOCATOR-REVIEW-2026-07-23-v1"

SOURCE_NAMES = {
    "DOM049-T01": "Official public source topic 049-01",
    "DOM049-T02": "Official public source topic 049-02",
    "DOM049-T03": "Official public source topic 049-03",
    "DOM049-T04": "Official public source topic 049-04",
    "DOM049-T05": "Official public source topic 049-05",
    "DOM049-T06": "Official public source topic 049-06",
    "DOM049-T07": "Official public source topic 049-07",
    "DOM050-T01": "Official public source topic 050-01",
    "DOM050-T02": "Official public source topic 050-02",
    "DOM050-T03": "Official public source topic 050-03",
    "DOM050-T04": "Official public source topic 050-04",
    "DOM050-T05": "Official public source topic 050-05",
    "DOM050-T06": "Official public source topic 050-06",
    "DOM050-T07": "Official public source topic 050-07",
    "DOM051-T01": "Official public source topic 051-01",
    "DOM051-T02": "Official public source topic 051-02",
    "DOM051-T03": "Official public source topic 051-03",
    "DOM051-T04": "Official public source topic 051-04",
    "DOM051-T05": "Official public source topic 051-05",
    "DOM051-T06": "Official public source topic 051-06",
    "DOM051-T07": "Official public source topic 051-07",
}
...
def main() -> None:
    ...
    if len(sources) != 21 or any(len({x["source_url"] for x in manifest["sources"] if x["key"].startswith(d)}) < 7 for d in ("DOM049", "DOM050", "DOM051")):
    ...
    validate(ds, catalog)
    claims = [c for c in catalog if c["domain_code"] in {"DOM049", "DOM050", "DOM051"}]
        ...
        json.dumps(
            {
                ...
                "claim_boundary": "Claim-level execution plan for issue #182 only; it is not evidence and predeclares no outcome.",
        ...
        json.dumps(
            {
                ...
                "source_manifest_sha256": manifest_sha,
                "claim_boundary": "Conservative manual review of 21 preregistered clinical-trial, medical-device and diagnostic topic URLs for issue #182; no source replacement after observation.",
    ...
    for row in rows:
        ...
        card = {
            ...
            "runner_command": "python scripts/claimbound_review_claim_batch_182.py --manifest <local> --raw-root <local> --meta-root <local> --text-root <local> --operator <handle>",
