#!/usr/bin/env python3
"""Publish conservatively reviewed issue #174 source-boundary cards."""
...
REPORT = ROOT / "artifacts/claim_batch_174_manual_review.json"
EXECUTION = ROOT / "artifacts/claim_batch_174_execution_manifest.json"
PROTOCOL = "CB7K-ISSUE-174-CONSERVATIVE-LOCATOR-REVIEW-2026-07-23-v1"

SOURCE_NAMES = {
    "DOM025-T01": "Official public source topic 025-01",
    "DOM025-T02": "Official public source topic 025-02",
    "DOM025-T03": "Official public source topic 025-03",
    "DOM025-T04": "Official public source topic 025-04",
    "DOM025-T05": "Official public source topic 025-05",
    "DOM025-T06": "Official public source topic 025-06",
    "DOM025-T07": "Official public source topic 025-07",
    "DOM026-T01": "Official public source topic 026-01",
    "DOM026-T02": "Official public source topic 026-02",
    "DOM026-T03": "Official public source topic 026-03",
    "DOM026-T04": "Official public source topic 026-04",
    "DOM026-T05": "Official public source topic 026-05",
    "DOM026-T06": "Official public source topic 026-06",
    "DOM026-T07": "Official public source topic 026-07",
    "DOM027-T01": "Official public source topic 027-01",
    "DOM027-T02": "Official public source topic 027-02",
    "DOM027-T03": "Official public source topic 027-03",
    "DOM027-T04": "Official public source topic 027-04",
    "DOM027-T05": "Official public source topic 027-05",
    "DOM027-T06": "Official public source topic 027-06",
    "DOM027-T07": "Official public source topic 027-07",
}
...
def main() -> None:
    ...
    if len(sources) != 21 or any(len({x["source_url"] for x in manifest["sources"] if x["key"].startswith(d)}) < 7 for d in ("DOM025", "DOM026", "DOM027")):
    ...
    validate(ds, catalog)
    claims = [c for c in catalog if c["domain_code"] in {"DOM025", "DOM026", "DOM027"}]
        ...
        json.dumps(
            {
                ...
                "claim_boundary": "Claim-level execution plan for issue #174 only; it is not evidence and predeclares no outcome.",
        ...
        json.dumps(
            {
                ...
                "source_manifest_sha256": manifest_sha,
                "claim_boundary": "Conservative manual review of 21 preregistered clinical-trial, medical-device and diagnostic topic URLs for issue #174; no source replacement after observation.",
    ...
    for row in rows:
        ...
        card = {
            ...
            "runner_command": "python scripts/claimbound_review_claim_batch_174.py --manifest <local> --raw-root <local> --meta-root <local> --text-root <local> --operator <handle>",
