#!/usr/bin/env python3
"""Publish conservatively reviewed issue #181 source-boundary cards."""
...
REPORT = ROOT / "artifacts/claim_batch_181_manual_review.json"
EXECUTION = ROOT / "artifacts/claim_batch_181_execution_manifest.json"
PROTOCOL = "CB7K-ISSUE-181-CONSERVATIVE-LOCATOR-REVIEW-2026-07-23-v1"

SOURCE_NAMES = {
    "DOM046-T01": "Official public source topic 046-01",
    "DOM046-T02": "Official public source topic 046-02",
    "DOM046-T03": "Official public source topic 046-03",
    "DOM046-T04": "Official public source topic 046-04",
    "DOM046-T05": "Official public source topic 046-05",
    "DOM046-T06": "Official public source topic 046-06",
    "DOM046-T07": "Official public source topic 046-07",
    "DOM047-T01": "Official public source topic 047-01",
    "DOM047-T02": "Official public source topic 047-02",
    "DOM047-T03": "Official public source topic 047-03",
    "DOM047-T04": "Official public source topic 047-04",
    "DOM047-T05": "Official public source topic 047-05",
    "DOM047-T06": "Official public source topic 047-06",
    "DOM047-T07": "Official public source topic 047-07",
    "DOM048-T01": "Official public source topic 048-01",
    "DOM048-T02": "Official public source topic 048-02",
    "DOM048-T03": "Official public source topic 048-03",
    "DOM048-T04": "Official public source topic 048-04",
    "DOM048-T05": "Official public source topic 048-05",
    "DOM048-T06": "Official public source topic 048-06",
    "DOM048-T07": "Official public source topic 048-07",
}
...
def main() -> None:
    ...
    if len(sources) != 21 or any(len({x["source_url"] for x in manifest["sources"] if x["key"].startswith(d)}) < 7 for d in ("DOM046", "DOM047", "DOM048")):
    ...
    validate(ds, catalog)
    claims = [c for c in catalog if c["domain_code"] in {"DOM046", "DOM047", "DOM048"}]
        ...
        json.dumps(
            {
                ...
                "claim_boundary": "Claim-level execution plan for issue #181 only; it is not evidence and predeclares no outcome.",
        ...
        json.dumps(
            {
                ...
                "source_manifest_sha256": manifest_sha,
                "claim_boundary": "Conservative manual review of 21 preregistered clinical-trial, medical-device and diagnostic topic URLs for issue #181; no source replacement after observation.",
    ...
    for row in rows:
        ...
        card = {
            ...
            "runner_command": "python scripts/claimbound_review_claim_batch_181.py --manifest <local> --raw-root <local> --meta-root <local> --text-root <local> --operator <handle>",
