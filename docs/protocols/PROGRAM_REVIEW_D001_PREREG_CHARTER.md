# PROGRAM_REVIEW_D001 Pre-Registration Charter
...
This track may check only a narrow `evidence_appendix` claim for the source
...
- Audience: Program reviewers and evaluators
