# PROCUREMENT_AI_D001 Pre-Registration Charter
...
This track may check only a narrow `procurement_claim_check` claim for the source
...
- Source name: xAI Grok 4 API documentation
- Source URL: https://docs.x.ai/developers/models/grok-4
- Domain: public-procurement
- Audience: Independent verifiers procurement teams and public buyers
