# MODEL_EVAL_D001 Pre-Registration Charter
...
This track may check only a narrow `model_benchmark_claim` claim for the source
...
- Audience: AI and LLM evaluation teams
