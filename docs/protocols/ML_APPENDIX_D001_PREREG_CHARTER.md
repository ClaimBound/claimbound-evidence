# ML_APPENDIX_D001 Pre-Registration Charter
...
This track may check only a narrow `research_method_appendix` claim for the source
...
- Source name: NASA POWER Daily point API
