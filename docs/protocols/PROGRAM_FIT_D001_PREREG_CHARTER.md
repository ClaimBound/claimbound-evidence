# PROGRAM_FIT_D001 Pre-Registration Charter
...
- Source name: Public source under review
- Source URL: source identity withheld from public card to avoid implying program-sponsor affiliation
- Domain: program-review
- Audience: public evidence operators
