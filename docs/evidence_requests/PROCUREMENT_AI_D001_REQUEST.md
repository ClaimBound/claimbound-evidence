# Evidence Request: PROCUREMENT_AI_D001
...
Independent verifiers procurement teams and public buyers
...
- xAI Grok 4 API documentation: https://docs.x.ai/developers/models/grok-4
