...
| AI tooling and agent-infra users | Whether Headroom v0.27.0 wide token-compression claims stay inside narrow local evidence boundaries. | [Source boundary JSON](CLAIMBOUND-HEADROOM_SOURCE_BOUNDARY_D001-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_SOURCE_BOUNDARY_D001-2026-06-23.svg)<br>[Memory boundary JSON](CLAIMBOUND-HEADROOM_MEMORY_NOT_REQUIRED_D001-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_MEMORY_NOT_REQUIRED_D001-2026-06-23.svg)<br>[Ollama JSON gate JSON](CLAIMBOUND-HEADROOM_OLLAMA_JSON_TOOL_OUTPUT_D001-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_OLLAMA_JSON_TOOL_OUTPUT_D001-2026-06-23.svg)<br>[Ollama log gate JSON](CLAIMBOUND-HEADROOM_OLLAMA_LOG_OUTPUT_D001-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_OLLAMA_LOG_OUTPUT_D001-2026-06-23.svg)<br>[Ollama history gate JSON](CLAIMBOUND-HEADROOM_OLLAMA_AGENT_HISTORY_D001-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_OLLAMA_AGENT_HISTORY_D001-2026-06-23.svg)<br>[RAG/plain-text boundary JSON](CLAIMBOUND-HEADROOM_RAG_PLAIN_TEXT_D001-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_RAG_PLAIN_TEXT_D001-2026-06-23.svg)<br>[Code/file boundary JSON](CLAIMBOUND-HEADROOM_CODE_FILE_DEFAULT_D001-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_CODE_FILE_DEFAULT_D001-2026-06-23.svg)<br>[Codex route boundary JSON](CLAIMBOUND-HEADROOM_CODEX_PROXY_ROUTE_D001-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_CODEX_PROXY_ROUTE_D001-2026-06-23.svg)<br>[Codex same-answer JSON](CLAIMBOUND-HEADROOM_CODEX_SAME_ANSWER_D001-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_CODEX_SAME_ANSWER_D001-2026-06-23.svg)<br>[CCR source boundary JSON](CLAIMBOUND-HEADROOM_CCR_SOURCE_BOUNDARY_D002-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_CCR_SOURCE_BOUNDARY_D002-2026-06-23.svg)<br>[CCR MCP full retrieve JSON](CLAIMBOUND-HEADROOM_CCR_MCP_FULL_RETRIEVE_D002-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_CCR_MCP_FULL_RETRIEVE_D002-2026-06-23.svg)<br>[CCR MCP query retrieve JSON](CLAIMBOUND-HEADROOM_CCR_MCP_QUERY_RETRIEVE_D002-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_CCR_MCP_QUERY_RETRIEVE_D002-2026-06-23.svg)<br>[Direct compress CCR boundary JSON](CLAIMBOUND-HEADROOM_DIRECT_COMPRESS_NOT_CCR_D002-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_DIRECT_COMPRESS_NOT_CCR_D002-2026-06-23.svg)<br>[Proxy compress endpoint JSON](CLAIMBOUND-HEADROOM_PROXY_COMPRESS_ENDPOINT_D003-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_PROXY_COMPRESS_ENDPOINT_D003-2026-06-23.svg)<br>[Proxy CCR hash retrieve JSON](CLAIMBOUND-HEADROOM_PROXY_CCR_HASH_RETRIEVE_D003-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_PROXY_CCR_HASH_RETRIEVE_D003-2026-06-23.svg)<br>[Codex proxy boundary D003 JSON](CLAIMBOUND-HEADROOM_CODEX_PROXY_BOUNDARY_D003-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_CODEX_PROXY_BOUNDARY_D003-2026-06-23.svg)<br>[Ollama JSON semantic D004 JSON](CLAIMBOUND-HEADROOM_OLLAMA_JSON_SEMANTIC_SAVINGS_D004-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_OLLAMA_JSON_SEMANTIC_SAVINGS_D004-2026-06-23.svg)<br>[Ollama log semantic D004 JSON](CLAIMBOUND-HEADROOM_OLLAMA_LOG_SEMANTIC_SAVINGS_D004-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_OLLAMA_LOG_SEMANTIC_SAVINGS_D004-2026-06-23.svg)<br>[Ollama history semantic D004 JSON](CLAIMBOUND-HEADROOM_OLLAMA_HISTORY_SEMANTIC_SAVINGS_D004-2026-06-23.json) / [SVG](CLAIMBOUND-HEADROOM_OLLAMA_HISTORY_SEMANTIC_SAVINGS_D004-2026-06-23.svg) | Source/memory/RAG/code boundaries: `PASSED_UNDER_PROTOCOL`<br>Ollama runtime gates: `NEGATIVE_RESULT_UNDER_PROTOCOL`<br>Codex cards: `INSUFFICIENT_COVERAGE`<br>CCR/MCP D002 cards: `PASSED_UNDER_PROTOCOL`<br>D003 proxy: compress `PASSED_UNDER_PROTOCOL`, CCR retrieve `NEGATIVE_RESULT_UNDER_PROTOCOL`, Codex boundary `INSUFFICIENT_COVERAGE`<br>D004 semantic/Ollama cards: `NEGATIVE_RESULT_UNDER_PROTOCOL` |
