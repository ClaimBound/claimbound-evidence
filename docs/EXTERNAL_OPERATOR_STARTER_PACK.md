...
| --- | --- | --- |
| Close VERIFY issues | You were asked to verify maintainer deliverables (#85–#87). | [Volunteer one-pager](external_verification/VOLUNTEER_ONE_PAGER.md) — ~15 min first time, ~5 min per pack after setup |
