...
1. Open the public claim source: https://github.com/ClaimBound/claimbound-public-benchmarks
...
```text
docs/protocols/FUNDING_REVIEW_D001_PREREG_CHARTER.md
docs/manual_audit/FUNDING_REVIEW_D001_CHECKLIST.md
docs/evidence_cards/CLAIMBOUND-FUNDING_REVIEW_D001-<DATE>.json
artifacts/funding_review_d001_summary.json
```
