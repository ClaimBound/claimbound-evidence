...
1. Open the public claim source: https://www.nyc.gov/site/tlc/about/tlc-trip-record-data.page
...
```text
docs/protocols/CIVIC_CLAIM_D001_PREREG_CHARTER.md
docs/manual_audit/CIVIC_CLAIM_D001/CIVIC_CLAIM_D001_CHECKLIST.md
docs/evidence_cards/CLAIMBOUND-CIVIC_CLAIM_D001-<DATE>.json
artifacts/civic_claim_d001_summary.json
```
