...
rerunnable map of exactly what each selected source page supports. Open the
[interactive atlas entry point](docs/esa/atlas/index.html) locally, read the
[heatmap methodology](docs/esa/ESA_500_HEATMAP.md) and
