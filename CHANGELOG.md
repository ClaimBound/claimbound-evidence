...
- Added `FUNDING_FIT_D001` as a completed non-branded public funding-eligibility self-check card with explicit single-operator and no-endorsement boundaries.
